...
public class DoctoresFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        DoctoresViewModel doctoresViewModel =
                new ViewModelProvider(this).get(DoctoresViewModel.class);

        binding = FragmentDoctoresBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textDoctores;
        doctoresViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
